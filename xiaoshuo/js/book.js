$(function () {
    ...
    $('.add').click(function (e) {
        ...
        window.localStorage.setItem('fonts',textFontSize)
    });
    ...
    $('.background .white').click(function (e) {
        ...
        window.localStorage.setItem('bgColor','white')
    });
    $('.background .green').click(function (e) {
        ...
        window.localStorage.setItem('bgColor','green')
    });
    $('.background .yellow').click(function (e) {
        ...
        window.localStorage.setItem('bgColor','yellow')
    ...
    $('.background .black-1').click(function (e) {
        ...
        window.localStorage.setItem('bgColor','black')
